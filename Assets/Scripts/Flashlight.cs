...
public class Flashlight : MonoBehaviour {
	...
	void Update()
	{
		...
		{
			GameObject blueLense = Instantiate(newLense, handle.position, handle.rotation) as GameObject;
			blueLense.transform.SetParent ( GameObject.FindGameObjectWithTag("Player").gameObject.transform, true);
			Destroy(gameObject);
		}
	}
}
